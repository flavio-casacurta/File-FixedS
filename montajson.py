...
for all copybooks of properties.txt file in the directory ['DIRSOUVAL'] with the extension ['EXTCPY']
'pathProp.txt' is the default of properties
...
'pathProp.txt' � o default do properties
'''
